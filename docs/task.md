...
- Разделите проблемы по критичности: критические / важные / было бы хорошо сделать.
...
TBD
- оформи тут все идеи, ответы и решения как подзаголовки начиная с 3го уровя ###
- сначала ответы для раздела Задачи, потом для раздела Вопрос про масштабирование