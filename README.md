Ниже — цельное решение тестового задания на **Laravel Queue + Filament**, рассчитанное на **production под параллельными воркерами**, с идемпотентностью, ретраями и админкой.
